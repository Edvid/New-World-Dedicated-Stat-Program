...
async function mapCalculations() {
  ...
  let nationPopXDevDistribution = await findDistribution(
    nationData,
    populationXDevelopmentData,
    "nation",
    "population",
...
function populationXDevelopmentMerger(mapIndex) {
  let pixelPop = FetchedRGBAsNum(isSetup ? popData : newPopData, mapIndex);
