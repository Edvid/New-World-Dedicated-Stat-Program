...
async function findDistribution(outerDataset, innerDataset, outerName, innerName, colorToOuterNameMapping, colorToInnerNameMapping, options) {
    ...
    for (let i = 0; i < pixelCount; i++) {
        ...
        if(typeof OuterNameOfPixel === 'undefined') {
            let foundOuterObject = await PromptName(outerCol, getOuterDataPoint, outerName);
            console.log(colorToOuterNameMapping);
            colorToOuterNameMapping["Col" + foundOuterObject.color] = foundOuterObject.name;
        }
