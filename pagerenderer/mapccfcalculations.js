...
async function scanMaps() {
    ...
    Object.keys(cultureDistribution).forEach(nationKey => {
        ...
        Object.keys(cultureDistribution[nationKey]).forEach(CultureKey => {
            ...
            autoGeneratedCffTextField.value += `= ${cultureDistribution[nationKey][CultureKey] * 100 / total} ${nationKey}.CultureGroups${CultureKey}.Points\n`
        });
    });
    ...
    Object.keys(religionDistribution).forEach(nationKey => {
        ...
        Object.keys(religionDistribution[nationKey]).forEach(ReligionKey => {
            ...
            autoGeneratedCffTextField.value += `= ${religionDistribution[nationKey][ReligionKey] * 100 / total} ${nationKey}.ReligionGroups${ReligionKey}.Points\n`
        });
    });
