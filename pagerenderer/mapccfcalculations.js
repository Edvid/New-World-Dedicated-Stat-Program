...
async function scanMaps() {
    ...
    const maxClimateScore = 1;
    const totalPossibleDevScore = WIDTH * HEIGHT * 255;
    const tradeZoneMultiplier = maxClimateScore * totalPossibleDevScore;
    console.log(tradeZoneMultiplier);
    Object.keys(tradeZoneScore).forEach(zoneKey => {
        let rawTradeZoneScore = tradeZoneScore[zoneKey];
        let idealTradeZoneScore = rawTradeZoneScore * 1000000 / tradeZoneMultiplier;
