...
async function scanImage() {
    ...
    for (let i = 0; i < nationData.length / 4; i++) {
        ...
        if(climateDataEmpty && nationDataEmpty) continue;
        ...
        nationCol = rgbToHex([nationData[i*4], nationData[i*4+1], nationData[i*4+2]]);
        climateCol = rgbToHex([climateData[i*4], climateData[i*4+1], climateData[i*4+2]]);
