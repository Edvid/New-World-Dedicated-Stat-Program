...
static evaluateNation(nationName) {
  ...
  n.EstateInfluencesReal = {
    ...
    n.MerchantsWage = n.MerchantShips > 0 ? ((n.InternalTrade * (1 - n.InternalTariffs) + n.ExternalTrade * (1 - n.ExternalTariffs)) / (n.Population / 1000 * n.Workforces.Merchants) * (1 - n.EstateInfluencesReal.BurgousieInfluence * 2)) : 0.5;
  ...
  n.MerchantsEffectiveWage = n.MerchantsWage * (1 - n.UrbanTax * n.TaxEfficiency * (1 - n.EstateInfluencesReal.UrbanInfluence)) + (n.ExpectedMerchantsSol < n.AverageExpectedSol ? n.SocialSpending / 10 : 0) - (n.PopulaceBasicArmaments * n.BasicArmamentsValue * n.MerchantsWeaponContribution) / max(n.Population * n.Workforces.Merchants / 1000, 1);
  ...
  n.AntitrustReformAdvanceCost = max(25, (n.GovernmentRepresentation.BurgousieRepresentation - n.GovernmentRepresentation.WorkersRepresentation + (n.AverageDevelopment < 0.1 ? n.GovernmentRepresentation.UrbanRepresentation : 0 - n.GovernmentRepresentation.UrbanRepresentation)) * (n.Reforms.Guilds ? 2 : 1) * (n.Reforms.GuildsBanned ? 3 : 1));
  n.AntitrustReformRegressionCost = max(25, (0 - n.GovernmentRepresentation.BurgousieRepresentation + n.GovernmentRepresentation.WorkersRepresentation - (n.AverageDevelopment < 0.1 ? n.GovernmentRepresentation.UrbanRepresentation : 0 - n.GovernmentRepresentation.UrbanRepresentation)));
