...
export function ValueTypeFix(statName, statValue) {
  ...
  //numbers
    ...
    if (numSize >= 5) {
      for (let i = 0; i < numString.length; i++) {
        ...
        if ((numSize - i - 1) % 3 == 0 && i + 1 < numSize) newNumString += " ";
      }
  ...
  } else return { value: statVal, appendable: false };
}
