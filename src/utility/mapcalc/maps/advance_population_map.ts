...
type PopRelevantDatasets = {
  [K in keyof PopRelavantProps]: ImageDataArray
}
type PopRelevantColorProperties = {
...
export function advancePopulationMap(imgArray: ImageDataArray, pixelIndex: number, options: advancePopulationMapOptions) {
