...
declare const am5: any, am5percent: any
...
import { type Byte } from "../utility/int_range.js";
...
async function onLoadStatTradeZoneWealth() {
  ...
  worldCanvas.onclick = function (e) {
    ...
    const data = Array.from(worldContext.getImageData(realPos.x, realPos.y, 1, 1).data) as [Byte, Byte, Byte, Byte];
    const dataRGB: [Byte, Byte, Byte] = [data[0], data[1], data[2]]
    console.log(data);
