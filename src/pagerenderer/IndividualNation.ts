...
nationImage.onload = async function () {
  ...
  climateImage.onload = async function () {
    ...
    const smallIslandGrowthSet = new Set<number>();
    const bigIslandGrowthSet = new Set<number>();

    const smallIslandGrowthSet2 = new Set<number>();
    const bigIslandGrowthSet2 = new Set<number>();
