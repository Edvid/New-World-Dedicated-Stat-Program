...
const promptLabel: HTMLElement = document.querySelector(".promptMissingInfoContainer label");
...
const copyToClipboardButton: HTMLButtonElement = document.querySelector("button#clipboard");
