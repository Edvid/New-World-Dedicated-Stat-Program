...
export class Nation implements units, RealReformCostTypes, estateStats {
  ...
  AristocracyLeviesCasualties: number;
  AristocracyMilitiaCasualties: number;
  AristocracyLightInfantryCasualties: number;
  AristocracyHeavyInfantryCasualties: number;
  AristocracyEliteInfantryCasualties: number;
  AristocracyArchersCasualties: number;
  AristocracyCrossbowmenCasualties: number;
  AristocracyMusketeersCasualties: number;
  AristocracyMusketMilitiaCasualties: number;
  AristocracyRiflemenCasualties: number;
  AristocracyLightCavalryCasualties: number;
  AristocracyHeavyCavalryCasualties: number;
  AristocracyEliteCavalryCasualties: number;
  ClergyLeviesCasualties: number;
  ClergyMilitiaCasualties: number;
  ClergyLightInfantryCasualties: number;
  ClergyHeavyInfantryCasualties: number;
  ClergyEliteInfantryCasualties: number;
  ClergyArchersCasualties: number;
  ClergyCrossbowmenCasualties: number;
  ClergyMusketeersCasualties: number;
  ClergyMusketMilitiaCasualties: number;
  ClergyRiflemenCasualties: number;
  ClergyLightCavalryCasualties: number;
  ClergyHeavyCavalryCasualties: number;
  ClergyEliteCavalryCasualties: number;
  BurgousieLeviesCasualties: number;
  BurgousieMilitiaCasualties: number;
  BurgousieLightInfantryCasualties: number;
  BurgousieHeavyInfantryCasualties: number;
  BurgousieEliteInfantryCasualties: number;
  BurgousieArchersCasualties: number;
  BurgousieCrossbowmenCasualties: number;
  BurgousieMusketeersCasualties: number;
  BurgousieMusketMilitiaCasualties: number;
  BurgousieRiflemenCasualties: number;
  BurgousieLightCavalryCasualties: number;
  BurgousieHeavyCavalryCasualties: number;
