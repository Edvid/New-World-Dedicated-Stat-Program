...
export function generateCCFForSocialBehaviourGroups(socialBehaviourGroupNamePlural, socialBehaviourDistribution) {
    let generatedText = "";
    Object.keys(socialBehaviourDistribution).forEach((nationKey) => {
        ...
        generatedText += trimIndents(`> ${nationKey}
       ...
       `);
        ...
        Object.keys(socialBehaviourDistribution[nationKey]).forEach((SocialBehaviourKey) => {
            ...
            generatedText += trimIndents(`= ${(socialBehaviourDistribution[nationKey][SocialBehaviourKey] * 100) / total} ${SocialBehaviourKey}.Points\n`);
        });
