...
export class Nation {
    ...
    UnemployedPoliticalAwareness;
    SlavesPoliticalAwareness;
    LabourersPoliticalAwareness;
    SerfsPoliticalAwareness;
    FarmersPoliticalAwareness;
    TownsfolkPoliticalAwareness;
    MerchantsPoliticalAwareness;
    SailorsPoliticalAwareness;
    SoldiersPoliticalAwareness;
    EducationEfficiency;
    ...
    AristocracyBasicArmaments;
    ClergyBasicArmaments;
    BurgousieBasicArmaments;
    PopulaceBasicArmaments;
    ...
    LabourersWeaponContribution;
    SerfsWeaponContribution;
    UnemployedWeaponContribution;
    FarmersWeaponContribution;
    TownsfolkWeaponContribution;
    MerchantsWeaponContribution;
    IntellectualsWeaponContribution;
    Workforces;
    PopInAgriculture;
    ProductionSectors;
    SocietalClasses;
