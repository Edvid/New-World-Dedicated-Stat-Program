...
export function evaluateNation(nationName) {
    ...
    const estateWithHighestRepresentation = Object.entries(n.GovernmentRepresentation)
        .sort(([_a_name, a_repValue], [_b_name, b_repValue]) => b_repValue - a_repValue).at(0);
    ...
    }
    {
        ...
        if (rels.length < 2)
            n.ReligionRepresentedAtGovernmentLevel = rels[0];
        if (culs.length < 2)
    ...
    const SocialBehaviourCalc = function (socialBehaviourGroup, socialBehaviourWorldwideGroups, socialGroupRepresentedAtGovernmentLevel) {
        ...
        for (const OpinionatedSocialBehaviourGroupName in socialBehaviourGroup) {
            ...
            for (const nameOfSocialBehaviourGroupToBeHadAnOpinionAbout in socialBehaviourGroup) {
                ...
                if (nameOfSocialBehaviourGroupToBeHadAnOpinionAbout == OpinionatedSocialBehaviourGroupName)
                    continue;
    ...
    n.BaseIronHarvest = (n.Climates.TaigaAndTundra.Pixels * 0.1 +
        ...
        n.Climates.CoastalDesert.Pixels * 0.2) / 2750 * n.MiningEfficiency * Number(n.Technologies.IronWorking);
    n.BaseIronHarvest = min(n.BaseIronHarvest, n.Population * 0.03 / 20000);
    n.BaseCoalHarvest = (n.Climates.TaigaAndTundra.Pixels * 0.1 +
        n.Climates.MontaneForest.Pixels * 0.75 +
        n.Climates.Medditereanian.Pixels * 0.2 +
        n.Climates.Arid.Pixels * 0.2 +
        n.Climates.Steppe.Pixels * 0.1 +
        ...
        n.Climates.Mountainous.Pixels * 1 +
        n.Climates.Desert.Pixels * 0.05 +
        n.Climates.CoastalDesert.Pixels * 0.2) / 2250 * n.MiningEfficiency * (n.Technologies.IronWorking ? 1 : 0.5);
    n.BaseCoalHarvest = min(n.BaseCoalHarvest, n.Population * 0.03 / 20000);
    n.BaseSulphurHarvest = (n.Climates.TaigaAndTundra.Pixels * 0.1 +
        n.Climates.MontaneForest.Pixels * 0.75 +
        n.Climates.Medditereanian.Pixels * 0.2 +
        n.Climates.Arid.Pixels * 0.2 +
        n.Climates.Steppe.Pixels * 0.1 +
        ...
        n.Climates.Mountainous.Pixels * 1 +
        n.Climates.Desert.Pixels * 0.05 +
        n.Climates.CoastalDesert.Pixels * 0.2) / 1750 * n.MiningEfficiency * (n.Technologies.IronWorking ? 1 : 0.5);
    ...
    n.AdministrativeDemand = (0 + n.Population / 1500000 + n.Health * 2 + education * 2 + n.SocialSpending * 1.5 + propagandaReal * 2 + populationControlReal * 2 + n.BirthControl * 4 +
    ...
    for (const resourceIndex in resourceTypes) { //in, out, effective resources
        ...
        if (resource == "Budget" || resource == "Food")
            continue;
    ...
    n.ForestsLeft = max((n.Climates.TaigaAndTundra.Pixels * 0.95 +
        ...
        n.Climates.CoastalDesert.Pixels * 0.2) - n.ForestsCutDown, 0);
    ...
    n.AverageExpectedSol = ((isNaN(n.Workforces.Slaves) ? 0 : n.Workforces.Slaves) * n.ExpectedSlavesSol +
    ...
    const luxuriesDemand = ((isNaN(n.Workforces.Slaves) ? 0 : n.Workforces.Slaves) * (n.ExpectedSlavesSol > 1 ? (n.ExpectedSlavesSol - 1) : 0) +
    ...
    const pseudoTradePower = (function () {
        ...
        for (const region in tradeZones) {
            ...
            const percent = allNationPoints != 0 ?
                (((typeof Point !== 'undefined') ? Point : 0) / allNationPoints)
                : 0;
    ...
    n.NavyUpkeep = (n.MerchantShips * n.UpkeepForOneMerchantShip +
    ...
    n.CulturalAdvance = (function () {
        ...
        for (const cultureadvance in n.CulturalAdvancements) {
            if (n.CulturalAdvancements[cultureadvance])
                ca++;
        }
        return ca;
    })();
